...
public class ChaCha20Jce {
    public static void main(String[] args) throws IOException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, InvalidKeyException {
        System.out.println("File En-/Decryption with ChaCha20 JCE");
        ...
        sr.nextBytes(nonce);
        // Get Cipher Instance
        Cipher cipherE = Cipher.getInstance("ChaCha20/None/NoPadding");
        ...
        cipherE.init(Cipher.ENCRYPT_MODE, keySpec, chaCha20ParameterSpec);
        // encryption
        ...
        Cipher cipherD = Cipher.getInstance("ChaCha20/None/NoPadding");
        // initialize the cipher for decryption
        cipherD.init(Cipher.DECRYPT_MODE, keySpec, chaCha20ParameterSpec);
